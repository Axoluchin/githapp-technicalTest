...
export default function Search() {
  ...
  const formSchema = z.object({
    user: z.string().min(1, 'Escribe al menos 1 carácter').max(30, 'Limite de caracteres excedido'),
  })
  ...
  return (
    <Form {...methods}>
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 w-full px-4 sm:w-96">
        <FormField
